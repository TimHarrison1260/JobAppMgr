...
namespace JobAppMgr.ViewModels
{
    public class CompanyViewModel
    {
        ...
        [DisplayName("Name")]
        [Required(ErrorMessage = "Company Name cannot be blank, please enter a Name.")]
        [StringLength(50, ErrorMessage = "Too long, the company Name cannot be longer than 50 characters.")]
